...
NATIVE_SOURCES = sub_native_compiler.c lexer.c parser.c semantic.c ir.c codegen_x64.c
...
test: all
	...
	@echo ""
	@echo "[TEST 3] Python transpilation..."
	./$(TRANS_TARGET) test_temp.sb python && echo "✓ Python transpilation passed"
	@echo ""
